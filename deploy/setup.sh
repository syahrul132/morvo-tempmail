...
certbot --nginx -d adzstore.my.id -d www.adzstore.my.id --non-interactive --agree-tos --email admin@adzstore.my.id || warn "SSL setup failed - run manually later: certbot --nginx -d morvo.me"
